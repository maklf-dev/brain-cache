...
- `git pull` : updates local repo with remote version
...
- `git log --all --oneline --graph --decorate` : shows commits with branches and design
- `git pull` : gets the latest GitHub version
...
- **other branchs** : for work on something safely in project, without ruin the real version
